...
From an original corpus of 1,900 screened federal opinion and order records, a one-case-one-unit census of the **594 decided cases** found **eighteen qualifying plaintiff-side judgments**—nine final contested judgments awarding relief, two final default judgments awarding relief, and seven liability determinations with the remedy still unresolved. About 3% of decided cases; across the per-period rates, **3.55% / 0.00% / 3.21%**, no decline or increase was detected (no equivalence is claimed). What moved is who fills the docket: the pro se share of decided cases rose from **59.9% to 75.9%**—and counsel had appeared in every one of the eighteen qualifying plaintiff-side judgments. **18 of 199 (9.0%)** represented cases ended in a qualifying judgment; **0 of 395** pro se cases did.
<!-- /claim-block -->
...
<picture>
  ...
  <img src="results/figures/fig1_composition_light.svg" width="760" alt="Across three periods, the pro se share of decided cases rises from 59.9 percent to 75.9 percent while qualifying plaintiff-side judgments remain rare; none of the eighteen qualifying judgments was pro se.">
</picture>
...
2. Follow the complete [18-of-594 worked example](replication/VERIFY_ONE_CLAIM.md).
