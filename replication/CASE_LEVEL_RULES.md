...
to 606 distinct decided case units. 105 units contain more than one kept row (229
...
- **Victories.** The eighteen qualifying plaintiff-side judgments carry unit-level
  ...
  is outside the 606-unit census.
...
from the unit-level columns -- the build script derives all 606 independently and
...
Applying these rules to the CSV yields, exactly: 606 decided case units, split
287 / 68 / 251 across P1 / P2 / P3; 206 represented and 400 pro se units;
