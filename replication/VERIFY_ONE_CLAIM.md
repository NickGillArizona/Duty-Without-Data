...
decided cases (18 of 594), none of them pro se -- from the public per-row record
...
registered values -- 594 decided cases; 282/63/249 across the three windows; 199
represented and 395 pro se; eighteen qualifying judgments (10/0/8); zero pro se
