...
- **Win-rate levels and trajectory**: T2 dated-decided (n = 995 document rows) at the document level; the reported outcome figures are the case-level series over the universal one-case-one-unit collapsed core (N = 594: 282/63/249).
