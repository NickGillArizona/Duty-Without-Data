...
half years: eighteen of 594 decided cases, or 3.0% (3.55% / 0.00% / 3.21% per period, none in
...
brought without a lawyer rose from 59.9% to 75.9%.

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="../results/figures/fig1_composition_dark.svg">
  <img src="../results/figures/fig1_composition_light.svg" width="760" alt="Line chart across three periods: the pro se share of the decided docket rises from 59.9% to 75.9%, while the qualifying-judgment rate runs at 3.55%, 0.00%, and 3.21% across the three periods; eighteen qualifying plaintiff-side judgments in all, none pro se.">
</picture>
<!-- /claim-block -->
