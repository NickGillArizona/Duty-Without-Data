...
A replication archive earns trust by what it discloses against itself. This page collects,
in one place, the project's principal limitations, adverse preregistered findings, and
superseded analyses. Detail and artifacts are in the linked appendices; the private
research records behind them are described in
[`replication/DATA_PROVENANCE.md`](replication/DATA_PROVENANCE.md).

## The series of record, and what was superseded

The reported Part II outcome series is the **case-level census**: 606 decided cases (one
case, one unit; 287/68/251 across P1/P2/P3), eighteen qualifying plaintiff-side judgments
...
- **Pre-trend (adverse to sharp shock-attribution).** A registered within-P1 split found
  ...
  [Appendix A-6 § A-6.9](article/appendices/Appendix_A6_Comparator_Analysis.md) and
...
- **Case-mix audit (inconclusive).** The registered selection audit on the case-level
  ...
  [Appendix A-7 § A-7.3](article/appendices/Appendix_A7_Selection_and_Participation.md).
