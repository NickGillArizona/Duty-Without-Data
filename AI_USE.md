...
| Validation | Re-reads by separately run models from different providers, including a full-universe fourth-coder re-read conducted without access to prior labels (masking limits documented in the validation report); programmatic quotation checks | Specified the validation design; reviewed disagreements and adverse findings | [`method/VALIDATION.md`](method/VALIDATION.md); [`article/appendices/Appendix_A4_Reproducibility_Audit.md`](article/appendices/Appendix_A4_Reproducibility_Audit.md) |
