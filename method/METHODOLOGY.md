...
- Case-level series ([`../results/series_2026-07.json`](../results/series_2026-07.json)): decided N = 283 / 63 / 249 (pooled **595**); **eighteen qualifying plaintiff-side judgments** (10 / 0 / 8; nine final contested, two final defaults, seven liability-only with remedy unresolved), a qualifying-judgment rate of **3.53% / 0.00% / 3.21%** (broad favorable 4.24 / 0.00 / 3.61); **zero pro se qualifying judgments** in any period (0 of 397 pooled; represented 18 of 198, 9.1%); case-level pro se docket share **60.1% / 60.3% / 75.9%**.
