...
- Case-level series ([`../results/series_2026-07.json`](../results/series_2026-07.json)): decided N = 282 / 63 / 249 (pooled **594**); **eighteen qualifying plaintiff-side judgments** (10 / 0 / 8; nine final contested, two final defaults, seven liability-only with remedy unresolved), a qualifying-judgment rate of **3.55% / 0.00% / 3.21%** (broad favorable 4.26 / 0.00 / 3.61); **zero pro se qualifying judgments** in any period (0 of 395 pooled; represented 18 of 199, 9.0%); case-level pro se docket share **59.9% / 58.7% / 75.9%**.
