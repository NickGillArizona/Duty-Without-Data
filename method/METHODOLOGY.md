...
- Case-level series ([`../results/series_2026-07.json`](../results/series_2026-07.json)): decided N = 283 / 65 / 250 (pooled **598**); **eighteen qualifying plaintiff-side judgments** (10 / 0 / 8; nine final contested, two final defaults, seven liability-only with remedy unresolved), a qualifying-judgment rate of **3.53% / 0.00% / 3.20%** (broad favorable 4.24 / 0.00 / 3.60); **zero pro se qualifying judgments** in any period (0 of 397 pooled; represented 18 of 201, 9.0%); case-level pro se docket share **60.1% / 56.9% / 76.0%**.
