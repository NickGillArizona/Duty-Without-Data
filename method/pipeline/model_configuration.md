...
| Haiku 4.5 Tier 3 adjudication | Billed via Anthropic console; not itemized in the OpenRouter export |
| Sonnet 4.6 Tier 4 adjudication | Billed via Anthropic console; not itemized in the OpenRouter export |
