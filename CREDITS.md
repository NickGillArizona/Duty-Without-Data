...
Nicholas Gill conceived and directs the project, developed the legal theory and study
design, made or ratified the legal and case-level adjudication decisions, and is
responsible for every published claim. Large-language-model agents assisted with
retrieval, structured classification, software, analysis, and documentation under the
published protocols in [`method/METHODOLOGY.md`](method/METHODOLOGY.md); model rosters
and configurations are documented below and in
[`method/pipeline/model_configuration.md`](method/pipeline/model_configuration.md).
Models are documented instruments, not authors.
...
**OpenRouter**
Multi-model LLM access for the classification pipeline was provided through the [OpenRouter API](https://openrouter.ai/). Individual model attributions (MiniMax M2.7, DeepSeek V3.2, Kimi K2.5, Claude Haiku 4.5, Claude Sonnet 4.6, Claude Opus 4.6) are documented in [`method/pipeline/model_configuration.md`](method/pipeline/model_configuration.md).
