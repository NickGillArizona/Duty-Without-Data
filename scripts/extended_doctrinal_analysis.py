...
def is_disability(c):
    return (c.get("primary_protected_class") == "disability"
            or "disability" in [p.lower() for p in (c.get("protected_classes") or [])]
            or c.get("disability_alleged")
            or c.get("is_ra_case"))
...
# Three-period framework used in the former Appendix C (relocated/archived 2026-06-16):
