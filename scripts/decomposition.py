"""
Kitagawa-Oaxaca-Blinder decomposition over the document-level decided-row layer,
stratified on representation mix.

Document-level pipeline diagnostic. This decomposition characterizes the
document-level layer and is not reported in the manuscript; the reported
case-level series is results/series_2026-07.json. See replication/REPRODUCE.md
(document-level pipeline diagnostics) for the boundary.

Period boundaries (three-period design, Part II.B of the Note):
    P1 : 2022-01-01  <=  date_filed  <  2024-06-28
    P2 : 2024-06-28  <=  date_filed  <  2025-02-05
    P3 : 2025-02-05  <=  date_filed  <=  2026-07-01
