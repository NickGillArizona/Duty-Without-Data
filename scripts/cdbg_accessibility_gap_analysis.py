...
def render_markdown(results: dict[str, object]) -> str:
    ...
    lines.append("Generated by: `scripts/cdbg_accessibility_gap_analysis.py` (repo-relative; no local paths)")
    lines.append(
